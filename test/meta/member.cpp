...
namespace
{
	struct const_left_reference
	{
		...
		[[nodiscard]] constexpr auto operator==(const const_left_reference&) const & noexcept -> bool
		{
			return true;
		}

		[[nodiscard]] constexpr auto operator==(const_left_reference&&) const & noexcept -> bool
		{
			return false;
		}
		...
		[[nodiscard]] constexpr auto operator==(const const_left_reference&) && noexcept -> bool
		{
			return false;
		}

		[[nodiscard]] constexpr auto operator==(const_left_reference&&) && noexcept -> bool
		{
			return false;
		}
	...
	struct right_reference
	{
		...
		[[nodiscard]] constexpr auto operator==(const right_reference&) const & noexcept -> bool
		{
			return false;
		}

		[[nodiscard]] constexpr auto operator==(right_reference&&) const & noexcept -> bool
		{
			return false;
		}
		...
		[[nodiscard]] constexpr auto operator==(const right_reference&) && noexcept -> bool
		{
			return false;
		}

		[[nodiscard]] constexpr auto operator==(right_reference&&) && noexcept -> bool
		{
			return true;
		}
	...
	public:
		...
		using type = std::conditional_t<Index == 0, const_left_reference, std::conditional_t<Index == 1, right_reference, std::string>>;
...
namespace
{
	...
	[[nodiscard]] constexpr auto test_walk() noexcept -> bool
	{
		...
		return //
				o_a.id == a.id + (a.id + a.id) and o_b.id == b.id - (b.id + b.id) and o_c == s;
	}
	...
	[[nodiscard]] constexpr auto test_walk_until() noexcept -> bool
	{
		...
		return //
				o_a.id == a.id + (a.id + a.id) and o_b.id == b.id - (b.id + b.id) and o_c == c;
	}
