...
namespace
{
	...
	static_assert(meta::min_value_of<ScopedEnum0>() == ScopedEnum0::E1);
	static_assert(meta::max_value_of<ScopedEnum0>() == ScopedEnum0::E4);

	static_assert(meta::min_value_of<ScopedEnum1>() == ScopedEnum1::E1);
	static_assert(meta::max_value_of<ScopedEnum1>() == ScopedEnum1::E4);
	...
	static_assert(meta::min_value_of<ScopedFlag0>() == ScopedFlag0::F0);
	static_assert(meta::max_value_of<ScopedFlag0>() == ScopedFlag0::F6);

	static_assert(meta::min_value_of<ScopedFlag1>() == ScopedFlag1::F1);
	static_assert(meta::max_value_of<ScopedFlag1>() == ScopedFlag1::F6);
	...
	template<meta::EnumNamePolicy Policy, typename EnumType>
	[[nodiscard]] constexpr auto test_full_name_of(const EnumType e, const std::string_view expected, const std::string_view split) noexcept -> bool
	{
	...
	static_assert(meta::value_of<ScopedFlag0, meta::EnumNamePolicy::WITH_SCOPED_NAME, true>("ScopedFlag0::F3+ScopedFlag0::F1337", "+", static_cast<ScopedFlag0>(42)) == static_cast<ScopedFlag0>(42));
	...
	static_assert(meta::value_of<ScopedFlag0, meta::EnumNamePolicy::WITH_SCOPED_NAME>("ScopedFlag0::F7", "+", static_cast<ScopedFlag0>(42)) == static_cast<ScopedFlag0>(42));
	...
	static_assert(meta::value_of<ScopedFlag1, meta::EnumNamePolicy::WITH_SCOPED_NAME, true>("ScopedFlag1::F3-ScopedFlag1::F1337", "-", static_cast<ScopedFlag1>(42)) == static_cast<ScopedFlag1>(42));
	...
	static_assert(meta::value_of<ScopedFlag1, meta::EnumNamePolicy::WITH_SCOPED_NAME>("ScopedFlag1::F7", "-", static_cast<ScopedFlag1>(42)) == static_cast<ScopedFlag1>(42));
}
