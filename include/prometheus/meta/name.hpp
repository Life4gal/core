...
struct prometheus_meta_name_struct_123456789_987654321 {};
...
namespace prometheus::meta
{
	...
	[[nodiscard]] constexpr auto name_of() noexcept -> std::string_view
	{
		...
		// MSVC
		// const class std::basic_string_view<char, struct std::char_traits<char>> `__calling_convention` `namespace`::get_full_function_name<struct `prometheus_meta_name_struct_123456789_987654321` >(void)
		constexpr std::string_view full_function_name = get_full_function_name<prometheus_meta_name_struct_123456789_987654321>();
		constexpr auto full_function_name_size = full_function_name.size();

		constexpr std::string_view dummy_struct_name{"struct prometheus_meta_name_struct_123456789_987654321"};
		...
		// CLANG/CLANG-CL
		// std::string_view `namespace`::get_full_function_name() [T = `prometheus_meta_name_struct_123456789_987654321`]
		constexpr std::string_view full_function_name = get_full_function_name<prometheus_meta_name_struct_123456789_987654321>();
		constexpr auto full_function_name_size = full_function_name.size();

		constexpr std::string_view dummy_struct_name{"prometheus_meta_name_struct_123456789_987654321"};
		constexpr auto dummy_struct_name_size = std::ranges::size(dummy_struct_name);
...
#else
		// GCC
		// constexpr std::string_view `namespace`::get_full_function_name() [with <template-parameter-1-1> = `prometheus_meta_name_struct_123456789_987654321`; std::string_view = std::basic_string_view<char>]
		constexpr std::string_view full_function_name = get_full_function_name<prometheus_meta_name_struct_123456789_987654321>();
		constexpr auto full_function_name_size = full_function_name.size();
