...
namespace prometheus
{
	namespace primitive
	{
		...
		struct [[nodiscard]] PROMETHEUS_COMPILER_EMPTY_BASE basic_ellipse<2, PointValueType, RadiusValueType, RotationValueType> final
				: meta::dimension<basic_ellipse<2, PointValueType, RadiusValueType, RotationValueType>>
		{
			...
			// warning: missing initializer for member ‘prometheus::primitive::basic_ellipse<2, float>::<anonymous>’ [-Wmissing-field-initializers]
...
#endif
			tuple_element<Index, prometheus::primitive::basic_ellipse<N, PointValueType, RadiusValueType, RotationValueType>> // NOLINT(cert-dcl58-cpp)
	{
		using type = prometheus::primitive::basic_ellipse<N, PointValueType, RadiusValueType, RotationValueType>::template element_type<Index>;
	};

	template<std::size_t N, typename PointValueType, typename RadiusValueType, typename RotationValueType>
	struct tuple_size<prometheus::primitive::basic_ellipse<N, PointValueType, RadiusValueType, RotationValueType>> // NOLINT(cert-dcl58-cpp)
			: std::integral_constant<std::size_t, 3> {};

	template<std::size_t N, typename PointValueType, typename RadiusValueType, typename RotationValueType>
	struct formatter<prometheus::primitive::basic_ellipse<N, PointValueType, RadiusValueType, RotationValueType>> // NOLINT(cert-dcl58-cpp)
	{
		...
		auto format(const prometheus::primitive::basic_ellipse<N, PointValueType, RadiusValueType, RotationValueType>& ellipse, FormatContext& context) const noexcept -> auto
		{
